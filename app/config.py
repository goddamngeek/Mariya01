...
#
# Кириллица в названиях работает только вместе с option "name_assets" /
# "name_expenses" в личном файле — без них корни невалидны (проверено на
# beancount 3.2). Поэтому option-ы живут в файле, который ведут руками, а не
# в том, что бот перезаписывает.
LEDGER_CURRENCY = "RUB"

LEDGER_ACCOUNTS = {
    "ОСТАП": ["Активы:Остап:Озон", "Активы:Остап:Наличные"],
    "МАША": ["Активы:Маша:Озон", "Активы:Маша:Наличные"],
}
...
LEDGER_DEFAULT_CATEGORY = "Расходы:Прочее"
